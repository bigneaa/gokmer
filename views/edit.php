...
<form method="post" action="edit.php" name="user_edit_form_name">
    ...
    (<?php echo WORDING_CURRENTLY; ?>: <?php echo htmlspecialchars($_SESSION['user_name']); ?>)
...
<form method="post" action="edit.php" name="user_edit_form_email">
    ...
    <input id="user_email" type="email" name="user_email" required/> (<?php echo WORDING_CURRENTLY; ?>
