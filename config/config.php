 ...
 */
define("EMAIL_PASSWORDRESET_URL", "http://127.0.0.1/gokmer/password_reset.php");
define("EMAIL_PASSWORDRESET_FROM", "no-reply@gokmer.com");
define("EMAIL_PASSWORDRESET_FROM_NAME", "Webmaster Aurelio Big NEAA");
define("EMAIL_PASSWORDRESET_SUBJECT", "Password reset for GO CAMEROON");
...
define("EMAIL_VERIFICATION_FROM", "no-reply@gokmer.com");
define("EMAIL_VERIFICATION_FROM_NAME", "Webmaster Aurelio Big NEAA");
define("EMAIL_VERIFICATION_SUBJECT", "Account activation for GO CAMEROON");
